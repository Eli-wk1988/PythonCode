...
class MainUi(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.left_button_1 = QtWidgets.QPushButton("华语流行")
        self.left_button_1.setObjectName('left_button')#qtawesome.icon('fa.music', color='white'), 
        self.left_button_2 = QtWidgets.QPushButton("在线FM")#qtawesome.icon('fa.sellsy', color='white'), 
        self.left_button_2.setObjectName('left_button')
        self.left_button_3 = QtWidgets.QPushButton("热门MV")#qtawesome.icon('fa.film', color='white'), 
        self.left_button_3.setObjectName('left_button')
        self.left_button_4 = QtWidgets.QPushButton("本地音乐")#qtawesome.icon('fa.home', color='white'), 
        self.left_button_4.setObjectName('left_button')
        self.left_button_5 = QtWidgets.QPushButton("下载管理")#qtawesome.icon('fa.download', color='white'), 
        self.left_button_5.setObjectName('left_button')
        self.left_button_6 = QtWidgets.QPushButton("我的收藏")#qtawesome.icon('fa.heart', color='white'), 
        self.left_button_6.setObjectName('left_button')
        self.left_button_7 = QtWidgets.QPushButton("反馈建议")#qtawesome.icon('fa.comment', color='white'), 
        self.left_button_7.setObjectName('left_button')
        self.left_button_8 = QtWidgets.QPushButton("关注我们")#qtawesome.icon('fa.star', color='white'), 
        self.left_button_8.setObjectName('left_button')
        self.left_button_9 = QtWidgets.QPushButton("遇到问题")#qtawesome.icon('fa.question', color='white'), 
